...
export class StorageAccounts {
    ...
    public async list(options: any): Promise<Model.StorageAccount[]> {
    ...
    public async listClassicAndRMAccounts(options: any): Promise<Model.StorageAccount[]> {
        var httpRequest = new webClient.WebRequest();
         httpRequest.method = 'GET';
         httpRequest.headers = this.client.setCustomHeaders(options);
    ...
    public async listKeys(resourceGroupName: string, accountName: string, options: any, storageAccountType?: string): Promise<string[]> {
    ...
    public async get(storageAccountName: string): Promise<Model.StorageAccount> {
        ...
        let index = storageAccounts.findIndex(account => account.name !== undefined && account.name.toLowerCase() === storageAccountName.toLowerCase());
