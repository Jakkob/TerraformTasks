...
export class ServiceClient {
    ...
    public setCustomHeaders(options: Object): {} {
        var headers = {};
        if (options) {
            for (var headerName in (<any>options)['customHeaders']) {
                if ((<any>options)['customHeaders'].hasOwnProperty(headerName)) {
                    (<any>headers)[headerName] = (<any>options)['customHeaders'][headerName];
                }
            }
        }
        return headers;
